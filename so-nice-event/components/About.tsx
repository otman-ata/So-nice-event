    ...
    <section id="about" className="py-24 bg-[#fff4dc] moroccan-pattern zellige-band">
      ...
      >
        ...
        <div className="order-1 md:order-2">
          <div className="moroccan-arch rounded-lg border-8 border-white shadow-2xl shadow-[#450a0a]/20 overflow-hidden aspect-w-1 aspect-h-1 rotate-1 ring-1 ring-[#d9a629]/40">
            <CmsImageSlot
              siteKey="aboutUs"
