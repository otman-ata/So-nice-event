export interface GalleryImage {
  id: number;
  src: string;
  category: 'Weddings' | 'Private Events' | 'Corporate Events' | 'Baby Shower' | 'Birthdays' | 'Birth Celebration' | 'Graduation Parties';
}
...
export const defaultSiteImages = {
  ...
  heroSlides: ['/assets/images/hero-bg.jpeg', '/assets/images/service-wedding.jpeg', '/assets/images/gallery-4.jpeg'],
  ...
  serviceBirthCelebration: '/assets/images/gallery-5.jpeg',
  serviceGraduation: '/assets/images/gallery-7.jpeg',
